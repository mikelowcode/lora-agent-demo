...
Test utterance batteries are copied verbatim from the original tuning
diagnostics (not re-invented) so results are directly comparable:
  - lookup_request / explicit_search_action: Categories A-D from
    diagnostics/score_lookup_request_templates.py
  - research_intent: Categories T/L/K/F/E/G from
    diagnostics/score_research_intent_templates.py
  - episodic_relevance: POSITIVES/NEGATIVES from
    diagnostics/score_episodic_relevance_templates.py
...
# ---------------------------------------------------------------------------
# lookup_request / explicit_search_action — Categories A-D, verbatim from
# diagnostics/score_lookup_request_templates.py
# ---------------------------------------------------------------------------

_LR_CAT_A: list[tuple[str, str]] = [
    ("A", "Tell me how Localist works?"),
    ("A", "Can you read my wiki files?"),
    ("A", "List the files in my vault?"),
]

_LR_CAT_B: list[tuple[str, str]] = [
...
_LR_CAT_D: list[tuple[str, str, str]] = [
...
# ---------------------------------------------------------------------------
# research_intent — Categories T/L/K/F/E/G, verbatim from
# diagnostics/score_research_intent_templates.py
# ---------------------------------------------------------------------------
...
_RI_CAT_L_PRICE_ADJACENT: str = "Could you find out the current stock price for me?"
_RI_CAT_K: list[str] = [
    "What is this?",
...
# ---------------------------------------------------------------------------
# episodic_relevance — POSITIVES/NEGATIVES, verbatim from
# diagnostics/score_episodic_relevance_templates.py
# ---------------------------------------------------------------------------

_EP_POSITIVES: list[str] = [
...
# A real live-reported failure this session, added on top of the original
# battery: the actual trigger for this whole investigation.
_EP_POSITIVES_LIVE: list[str] = [
